...
public class SceneSwitcher {
     ...
     * @throws IOException if the FXML file cannot be loaded
     */
    public static void switchScene(ActionEvent event, String fxmlFileName, String title) throws IOException {
     ...
     * @throws IOException if the FXML file cannot be loaded
     */
    public static FXMLLoader switchSceneAndGetController(ActionEvent event, String fxmlFileName) throws IOException {
        String fxmlPath = "/com/fittrack/view/" + fxmlFileName;
        FXMLLoader loader = new FXMLLoader(SceneSwitcher.class.getResource(fxmlPath));
        Parent root = loader.load();
